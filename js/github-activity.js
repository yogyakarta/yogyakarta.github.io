...
var templates = {
  ...
  UserHeader: '<div class="gha-header">\
                 ...
                 <div class="gha-user-info{{withoutName}}">Github Public Activity<p><small>IDWEBDesigner</small></p></div>\
                 <div class="gha-gravatar">{{{gravatarLink}}}</div>\
               </div><div class="gha-push"></div>',
  Footer: '<div class="gha-footer">Public Activity <a href="http://github.com/idwebdesigner" target="_blank">GitHub Activity Stream</a>',
